...
class _DateArthmeticContainer extends StatefulWidget {
  ...
  @override
  State<_DateArthmeticContainer> createState() =>
      _DateArthmeticContainerState();
}
                          ...
                          Container(
                              ...
                              child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    int month =
                                    convertMonthStringToNum(_selectedMonth);
                                    int year = _selectedYear;
                                    if (isDateValid(day, month, year) == true) {
                                      _bloc.eventSink.add(
                                          ClickConfirmBtnEvent(day, month, year));
                                    } else {
                                      showMessage(context,
                                          "invalid date!, pls do it again");
                                    }
                                  },
                                  child: Text("Confirm")))
                        ],
                    ...
                    children: [
                      StreamBuilder<NumberModel>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Text(
                              "The number is: ${snapshot.data?.id.toString()}",
